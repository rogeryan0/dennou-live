...
<li><a href="#label:2">インストール</a>
<ul>
<li><a href="#label:3">plotutils のインストール</a></li>
<li><a href="#label:4">GSL のインストール</a></li>
<li><a href="#label:5">rb-gsl のインストール</a></li>
</ul></li>
<li><a href="#label:6">使用例</a>
<ul>
<li><a href="#label:7">EOF 解析</a></li>
</ul></li>
</ul>
<p></ol>
<hr></p>
...
GSL 1.6 の全ての関数を網羅しています. <a href="http://rb-gsl.rubyforge.org">&lt;URL:http://rb-gsl.rubyforge.org&gt;</a> </p>
<ul>
<li>利点
<ul>
<li>無料で利用できる</li>
...
<h3><a name="2.1" href="#2.1">2.1</a> <a name="label:3">plotutils のインストール</a></h3><!-- RDLabel: "plotutils のインストール" -->
...
<h3><a name="2.2" href="#2.2">2.2</a> <a name="label:4">GSL のインストール</a></h3><!-- RDLabel: "GSL のインストール" -->

<p><a href="ftp://ftp.gnu.org/gnu/gsl/">GSL 公式ページ(GNU)</a>から</p>
<ul>
<li>gsl-1.6.tar.gz</li>
</ul>
<p>をダウンロードしましょう.</p>
...
# make install</pre>
<p>とします. これで終了です.</p>
<h3><a name="2.3" href="#2.3">2.3</a> <a name="label:5">rb-gsl のインストール</a></h3><!-- RDLabel: "rb-gsl のインストール" -->
...
<h2><a name="3" href="#3">3</a> <a name="label:6">使用例</a></h2><!-- RDLabel: "使用例" -->

<h3><a name="3.1" href="#3.1">3.1</a> <a name="label:7">EOF 解析</a></h3><!-- RDLabel: "EOF 解析" -->
