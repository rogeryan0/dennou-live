...
* ((<"最新 tar+gzip パッケージ(2012.02.29, ver.0.7.1)"|URL:../spml_current.tar.gz>))
...
* ((<"Latest tar+gzip package(2012.02.29, ver.0.7.1)"|URL:../spml_current.tar.gz>))
