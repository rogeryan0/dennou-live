...
!      2012/06/28  竹広真一: tee_module_polvel_RF_cn_diff.f90 よりタウ法に改造
!      2012/07/06  竹広真一: タウ法計算法変更
!      2012/08/24  竹広真一: 時間積分法変更
!      
!
program tee_module_polvel_RF_tau_cn_diff
  !
   ...
   !------------------- 出力 ----------------------
    subroutine output_gtool4_init
      ...
      call HistoryCreate( &                               ! ヒストリー作成
           file='tee_module_polvel_RF_tau_cn_diff.nc', &
...
end program tee_module_polvel_RF_tau_cn_diff
