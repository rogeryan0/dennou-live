...
!
!履歴  2009/09/16  竹広真一  et_galerkin_ND_cn_diff.f90 を fftj 用に改造
!
program et_galerkin_module_fftj_ND_cn_diff
  !
   ...
   !------------------- 出力 ----------------------
    subroutine output_gtool4_init
      ...
      call HistoryCreate( &                               ! ヒストリー作成
           file='et_galerkin_module_fftj_ND_cn_diff.nc', &
...
end program et_galerkin_module_fftj_ND_cn_diff
