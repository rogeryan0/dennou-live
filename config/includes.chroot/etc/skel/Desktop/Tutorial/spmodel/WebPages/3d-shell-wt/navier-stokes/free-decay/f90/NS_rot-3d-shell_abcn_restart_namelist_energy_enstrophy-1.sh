#!/usr/bin/env bash
#
# NS_rot-3d-shell_abcn_restart_namelist.f90 用実行シェルスクリプト
#
...
TITLE="Free decay turbulence problem of Newtonian fluid (Navier-Stokes) in a rotating spherical shell"
