...
!
!履歴  2010/04/18  竹広真一  wtq_diffcn_polmag.f90 より変更
!
program wtq_diff_cn_polmag_grid
...
99    continue
 ...
 !------------------- 拡散項 ----------------------
  subroutine CNImplicitPolmag(wz_Polmag,wr_Polmag,Diffc_o,Diffc_i,dt)
    ...
    real(8), dimension((nm+1)**2,0:kmo+kmi)     :: wzr_Polmag  ! ポロイダル磁場
 ...
 !------------------- 出力ルーチン ----------------------
  subroutine output_gtool4_init
    call HistoryCreate( &                                  ! ヒストリー作成
           file='wtq_diff_cn_polmag_grid.nc', &
...
end program wtq_diff_cn_polmag_grid
