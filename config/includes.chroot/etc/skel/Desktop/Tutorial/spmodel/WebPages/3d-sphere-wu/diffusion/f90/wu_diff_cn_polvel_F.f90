...
program wu_diff_cn_polvel_F
 ...
 !------------------- 時間積分 ----------------------
  do it=1,nt                               ! Crank-Nicolson 法による時間積分
     ...
     wu_Polvel = wu_LaplaPol2PolGrid_wu(wu_LaplaPolvel,cond='F')
...
99  continue
    ...
    subroutine CNDiffusionMatrixPolvel( Diffc, dt, DiffLUMatrix, kpivot )
      ...
      do l=0,lm
         ...
         wu_DI = wu_LaplaPol2PolGrid_wu(wu_DI,cond='F')
...
end program wu_diff_cn_polvel_F
