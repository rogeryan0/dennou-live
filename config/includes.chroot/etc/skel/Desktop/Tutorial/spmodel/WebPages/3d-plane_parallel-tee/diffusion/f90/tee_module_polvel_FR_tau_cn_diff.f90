...
!
!履歴  2009/12/29  竹広真一: et_FR_cn_diff.f90 より改造
!      2012/06/28  竹広真一: tee_module_polvel_FR_cn_diff.f90 よりタウ法に改造
!      2012/07/06  竹広真一: タウ法計算法変更
!      2012/08/24  竹広真一: 時間積分法変更
!      
!
program tee_module_polvel_FR_tau_cn_diff
  !
 ...
 !---- 空間解像度設定 ----
  ...
  integer, parameter  :: lm=10, mm=10, nm=21      ! 切断波数の設定(X,Y,Z)
 ...
 !---- 物理パラメター ----
  ...
  character(len=2), parameter :: VelBC='FR'     ! 速度場境界条件(RR/FF/RF/FR)
   ...
   !------------------- 出力 ----------------------
    subroutine output_gtool4_init
      ...
      call HistoryCreate( &                               ! ヒストリー作成
           file='tee_module_polvel_FR_tau_cn_diff.nc', &
...
end program tee_module_polvel_FR_tau_cn_diff
