...
!     φ' = 0 at y=-d/2,d/2
!
!履歴  2009/12/30  竹広真一: et_DD_cn_diff.f90 より改造
!
program tee_module_NN_cn_diff
  !
  ...
  !      時間積分 : Crank Nicolson 法
  !
  ! Solving 3-D Diffusioon equation (NN problem)
  !     dφ/dt = \nabla φ
  !     φ' = 0 at y=-d/2,d/2
  !
  !      計算結果比較のための解析解については解説文書
 ...
 !---- 物理パラメター ----
  ...
  character(len=2)            :: BC='NN'        ! 境界条件(DD/DN/ND/NN)
 ...
 !------------------- 初期値設定 ----------------------
  ...
  if ( l .ge. 0 .AND. m .ge. 0 .AND. n .ge. 0) then
     ...
     zyx_Phi=cos(2*l*Pi*zyx_X/XD)*cos(2*m*Pi*zyx_Y/YD)*cos(2*n*Pi*zyx_Z/ZD)
  else   if ( l .lt. 0 .AND. m .ge. 0 .AND. n .ge. 0) then
     write(6,*) 'Type of the initial value : sin(lx)*cos(my)cos(nz)'
     zyx_Phi=sin(2*l*Pi*zyx_X/XD)*cos(2*m*Pi*zyx_Y/YD)*cos(2*n*Pi*zyx_Z/ZD)
  else   if ( l .ge. 0 .AND. m .lt. 0 .AND. n .ge. 0) then
     write(6,*) 'Type of the initial value : cos(lx)*sin(my)cos(nz)'
     zyx_Phi=cos(2*l*Pi*zyx_X/XD)*sin(2*m*Pi*zyx_Y/YD)*cos(2*n*Pi*zyx_Z/ZD)
  else   if ( l .lt. 0 .AND. m .lt. 0 .AND. n .ge. 0) then
     write(6,*) 'Type of the initial value : sin(lx)*sin(my)cos(nz)'
     zyx_Phi=sin(2*l*Pi*zyx_X/XD)*sin(2*m*Pi*zyx_Y/YD)*cos(2*n*Pi*zyx_Z/ZD)
  else if ( l .ge. 0 .AND. m .ge. 0 .AND. n .lt. 0) then
     write(6,*) 'Type of the initial value : cos(lx)*cos(my)cos(nz)'
     zyx_Phi=cos(2*l*Pi*zyx_X/XD)*cos(2*m*Pi*zyx_Y/YD)*sin((2*n+1)*Pi*zyx_Z/ZD)
  else   if ( l .lt. 0 .AND. m .ge. 0 .AND. n .lt. 0) then
     write(6,*) 'Type of the initial value : sin(lx)*cos(my)cos(nz)'
     zyx_Phi=sin(2*l*Pi*zyx_X/XD)*cos(2*m*Pi*zyx_Y/YD)*sin((2*n+1)*Pi*zyx_Z/ZD)
  else   if ( l .ge. 0 .AND. m .lt. 0 .AND. n .lt. 0) then
     write(6,*) 'Type of the initial value : cos(lx)*sin(my)cos(nz)'
     zyx_Phi=cos(2*l*Pi*zyx_X/XD)*sin(2*m*Pi*zyx_Y/YD)*sin((2*n+1)*Pi*zyx_Z/ZD)
  else   if ( l .lt. 0 .AND. m .lt. 0 .AND. n .lt. 0) then
     write(6,*) 'Type of the initial value : sin(lx)*sin(my)cos(nz)'
     zyx_Phi=sin(2*l*Pi*zyx_X/XD)*sin(2*m*Pi*zyx_Y/YD)*sin((2*n+1)*Pi*zyx_Z/ZD)
  end if
...
end program tee_module_NN_cn_diff
