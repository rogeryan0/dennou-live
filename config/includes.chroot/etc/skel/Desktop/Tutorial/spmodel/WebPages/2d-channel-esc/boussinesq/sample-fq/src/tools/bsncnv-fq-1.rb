...
for j in [5, 10, 20, 22, 24]
  ...
  DCL::ueitlv
  DCL::uegtla(-0.05, 0.5, 0 )
  DCL::uetonf(Temp.val)
  DCL::udgcla(-0.05, 0.5, 0 )
  DCL::udcntz(Temp.val)
...
#########################################################################
  ...
  DCL::ueitlv
  DCL::uegtla(-9.793353096, 9.793353096, 0 )
  DCL::uetonf(Psi.val)
  DCL::udgcla(-9.793353096, 9.793353096, 0 )
  DCL::udcntz(Psi.val)
  DCL::ussttl(x_title, x_unit, y_title, y_unit)
  DCL::usdaxs
  DCL::sglset("LCLIP", false )
