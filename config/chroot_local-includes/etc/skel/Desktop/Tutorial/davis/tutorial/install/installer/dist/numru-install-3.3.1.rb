...
$Id: numru-install.rb,v 1.33 2005/01/06 14:07:38 koshiro Exp $

Change Log:

* 2005/01/06  KOSHIRO Tsuyoshi
  - (3.3.1)
...
if __FILE__ == $0
	...
	rubydcl = RbExtLib.new(
		...
		["http://www.gfd-dennou.org/arch/ruby/products/installer/patches/rubydcl150_cygwin.patch.gz"]
	)
	if GtkMajorVer == "1"
