...
$Id: numru-install.rb,v 1.49 2006/02/12 19:25:44 koshiro Exp $

Change Log:

* 2006/02/13  KOSHIRO Tsuyoshi <koshiro at gfd-dennou.org>
  - (3.4.7)
...
if __FILE__ == $0
	...
	netcdf = Software.new(
		...
		{},
		["http://www.gfd-dennou.org/arch/ruby/products/installer/patches/netcdf361_cygwin.patch.gz"]
	)
	fftw = Software.new(
		"fftw", "FFTW",
