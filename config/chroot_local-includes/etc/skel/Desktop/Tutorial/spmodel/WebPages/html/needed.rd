...
* Fortran 90 コンパイラ
  * 開発は PGI Fortran ver. 2011 および G95 Fortran Compiler ver. 0.93 で行なっています.
  * その他, 動作確認の取れているコンパイラは以下の通りです:
    * Fujitsu Fortran & C Compiler ver.5
    * Fujitsu Fortran Driver ver 1.0
    * Intel Fortran Compiler ver. 10.0, 11.0, 12.0
    * G95 Fortran Compiler ver. 0.91, 0.92
    * pgi Fortran Compiler ver.7, 8, 9
...
Debian GNU/Linux (i386, amd64) 環境ならば((<Debian パッケージ|URL:../debian/needed.htm>))が利用できます.
...
* Fortran90 compiler which can be used for building following libraries.
  * We use PGI Fortran Compiler ver. 2011 and G95 Fortran Compiler ver. 0.93.
* ((<ISPACK|URL:/library/ispack/>))
* ((<NetCDF|URL:http://www.unidata.ucar.edu/packages/netcdf/>))
  * Mirror site is ((<here|URL:/library/ucar/netcdf/>))
* ((<gtool5|URL:/library/gtool/>))

((<"Debian GNU/Linux binary packages"|URL:../debian/needed.htm.en>)) (i386, amd64) are available.
