...
!
program wt_zonal_galerkin_module_sjpack_RR_cn_diff
  !
 ...
 !------------------- 出力ルーチン ----------------------
  subroutine output_gtool4_init
    ...
    call HistoryCreate( &                                  ! ヒストリー作成
           file='wt_zonal_galerkin_module_sjpack_RR_cn_diff.nc', &
...
end program wt_zonal_galerkin_module_sjpack_RR_cn_diff
