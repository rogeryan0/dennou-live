...
!
!履歴  2006/02/12  竹広真一: 新規作成
!      2006/03/03  竹広真一 RDoc 用にコメント修正
!      2009/09/16  竹広真一 境界条件スイッチを S->F に変更
!      
program et_galerkin_RR_cn_diff
  !
   ...
   !------------------- 出力 ----------------------
    subroutine output_gtool4_init
      ...
      call HistoryCreate( &                               ! ヒストリー作成
           file='et_galerkin_RR_cn_diff.nc', &
...
end program et_galerkin_RR_cn_diff
