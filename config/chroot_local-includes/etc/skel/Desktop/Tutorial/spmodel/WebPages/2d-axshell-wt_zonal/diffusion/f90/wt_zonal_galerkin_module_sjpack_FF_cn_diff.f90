...
!
!履歴  2009/10/04  竹広真一 wt_zonal_galerkin_FF_cn_diff.f90 より sjpack 用に改造
!
program wt_zonal_galerkin_module_sjpack_FF_cn_diff
  !
 ...
 !------------------- 出力ルーチン ----------------------
  subroutine output_gtool4_init
    ...
    call HistoryCreate( &                                  ! ヒストリー作成
           file='wt_zonal_galerkin_module_sjpack_FF_cn_diff.nc', &
...
end program wt_zonal_galerkin_module_sjpack_FF_cn_diff
