...
program bsncnv1
 ...
 !---- 時間積分パラメター ----
  ...
  integer, parameter :: nt=25000, ndisp=2500    ! 時間積分数, 表示ステップ

 !---- 物理パラメター ----
  character(len=2), parameter :: TempBC='DD'    ! 温度境界条件(DD/DN/ND/NN)
  character(len=2), parameter :: PsiBC='RR'     ! 流れ境界条件(RR/RF/FR/FF)
...
contains
    ...
    subroutine output_gtool4_init
      call HistoryCreate( &                               ! ヒストリー作成
           file='bsncnv_1_et_rr.nc', title='Boussinesq convection (TT)', &
