...
program gami_vrotv_abcn_bench0
 ...
 !---- NAMELIST 変数 ----
  ...
  character(len=100) :: output_file='gami_vrotv_abcn_bench0.nc'  ! 出力ファイル名
...
end program gami_vrotv_abcn_bench0
