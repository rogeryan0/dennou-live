...
!----------------------------------------------------------------------
!
!表題  wt_galerkin_module
!
!      3 次元球殻領域
!      球面調和函数展開 + チェビシェフ−ガラーキン法
!
!履歴  2009/01/02  佐々木洋平 作成開始
!      2010/03/10  佐々木洋平  threadprivate 削除(コンパイラ依存)
!             
!
!++
module wt_galerkin_module
  !
  != wt_galerkin_module
  !
  ! Authors:: Youhei SASAKI
  ! Version:: $Id: wt_galerkin_module.f90,v 1.11 2010-03-02 10:09:07 uwabami Exp $
  ...
  !--------------- 初期化 -----------------
    subroutine wt_galerkin_Initial(i,j,k,n,l,r_in,r_out,&
      ...
      call MessageNotify('M','wt_galerkin_initial','wt_galerkin_module is initialized')
