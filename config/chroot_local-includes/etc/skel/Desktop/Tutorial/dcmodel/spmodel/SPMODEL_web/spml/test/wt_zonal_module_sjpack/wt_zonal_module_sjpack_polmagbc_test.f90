...
!      磁場ポロイダルポテンシャルの境界値問題
!
!履歴  2009/09/26  竹広真一   wt_module_sjpack_polmagbc_test.f90 より改造
!
program wt_zonal_module_sjpack_polmagbc_test
  ...
  real(8), dimension(nm+1,0:km)            :: wz_Zero
  ...
  call MessageNotify('M','wt_zonal_module_sjpack_polmagbc_test', &
       'wt_zonal_module_sjpack wt_PolmagBoundaries subroutine test')
  ...
  call MessageNotify('M','wt_zonal_module_sjpack_polmagbc_test', &
       'wt_zonal_module_sjpack wt_PolmagBoundaries subroutine test succeeded!')

end program wt_zonal_module_sjpack_polmagbc_test
