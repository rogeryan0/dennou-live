...
!
program wq_module_sjpack_polmagbc_test
  ...
  call MessageNotify('M','wq_module_sjpack_polmagbc_test', &
       'wq_module_sjpack wq_PolmagBoundary subroutine test')
  ...
  call MessageNotify('M','wq_module_sjpack_polmagbc_test', &
       'wq_module_sjpack wq_PolmagBoundary subroutine test succeeded!')

end program wq_module_sjpack_polmagbc_test
