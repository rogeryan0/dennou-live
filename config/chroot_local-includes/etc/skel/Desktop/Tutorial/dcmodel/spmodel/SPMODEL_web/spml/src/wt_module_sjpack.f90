...
!表題  wt_module
!
!    spml/wt_module_sjpack モジュールは球面上および球殻内での流体運動を
...
!    wt_module_sjpack のものは初期化したのちにしか使うことができない. 
!
!
!履歴  2009/09/06  竹広真一  wt_module を SJPACK 対応に改造
!      2009/09/20  竹広真一  使用上の注意を追加
!      2009/09/24  竹広真一  nmz_*, nz_* の計算修正
...
!
!++
module wt_module_sjpack
  !
  != wt_module_sjpack
  !
  ! Authors:: Shin-ichi Takehiro, Youhei SASAKI
  ! Version:: $Id: wt_module_sjpack.f90,v 1.6 2010-03-02 10:09:07 uwabami Exp $
  ...
  !--------------- 初期化 -----------------
   subroutine wt_Initial(i,j,k,n,l,r_in,r_out,np,wa_init)
     ...
     call MessageNotify('M','wt_initial', &
          'wt_module_sjpack (2009/09/06) is initialized')
