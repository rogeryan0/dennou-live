...
module wq_module
  ...
  ! Version:: $Id: wq_module.f90,v 1.12 2010-03-02 10:09:06 uwabami Exp $
  ...
  !--------------- 初期化 -----------------
   subroutine wq_Initial(i,j,k,n,l,r,np,wa_init)
    ...
    call MessageNotify('M','wq_initial','wq_module (2009/12/06) is initialized')
