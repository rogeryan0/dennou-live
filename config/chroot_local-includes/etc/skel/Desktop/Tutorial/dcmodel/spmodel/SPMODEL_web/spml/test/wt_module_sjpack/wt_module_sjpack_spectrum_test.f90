...
!----------------------------------------------------------------------
!
!表題  wt_module_sjpack テストプログラム :: スペクトル関数のテスト
!
!履歴  2009/09/25  竹広真一 
!
program wt_module_sjpack_spectrum_test
  ...
  call MessageNotify('M','wt_module_sjpack_spectrum_test',&
                         'wt_module_sjpack spectrum functions tests.') 
  ...
  call MessageNotify('M','wt_module_sjpack_spectrum_test',&
                         'wt_module_sjpack spectrum functions tests suceeded!') 

end program wt_module_sjpack_spectrum_test
