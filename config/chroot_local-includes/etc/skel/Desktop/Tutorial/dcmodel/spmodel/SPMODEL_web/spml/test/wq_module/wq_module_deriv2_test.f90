...
program wq_module_deriv2_test
  ...
  call MessageNotify('M','wq_module_deriv2_test', &
...
! ----------------- 例 2 --------------------
  ...
  call MessageNotify('M','wq_module_deriv2_test', &
       'wq_module derivative function test #2 succeeded!')

end program wq_module_deriv2_test
