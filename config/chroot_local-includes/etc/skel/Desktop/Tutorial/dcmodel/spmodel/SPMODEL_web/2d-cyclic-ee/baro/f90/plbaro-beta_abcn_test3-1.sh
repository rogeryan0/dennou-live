#!/usr/bin/env bash
#
# plbaro_abcn_test3-1.f90 用実行シェルスクリプト
#
...
#  real(8)            :: HVisc              ! 超粘性係数
 ...
 &physics XLength=10.0D0, YLength=10.0D0, Beta=1.0, HVOrder=2, HVisc=1.0D-7 /

#---------------------------- 実験パラメター ----------------------------
#                                           !---- 初期値 1 モドン
#  real(8) :: Radius                        ! モドン半径
#  real(8) :: Speed                         ! モドン伝播速度
#  real(8) :: XCenter                       ! 初期中心位置 X 座標
#  real(8) :: YCenter                       ! 初期中心位置 Y 座標

 &modon Radius=1.0D0, Speed=1.0D0, XCenter=5.0D0, YCenter=5.0D0 /
