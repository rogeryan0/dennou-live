...
!
program wq_module_sjpack_torvelbc_test
  ...
  call MessageNotify('M','wq_module_sjpack_torvelbc_test', &
       'wq_module_sjpack wq_TorvelBoundary subroutine test')
  ...
  call MessageNotify('M','wq_module_sjpack_torvelbc_test', &
       'wq_module_sjpack wq_TorvelBoundary subroutine test succeeded!')

end program wq_module_sjpack_torvelbc_test
