...
!
program wq_module_integral_test
  ...
  call MessageNotify('M','wq_module_integral_test', &
       'wq_module integration functions tests')
 ...
 ! r^2 
  ...
  call MessageNotify('M','wq_module_integral_test', &
       'wq_module averaging functions tests')
...
end program wq_module_integral_test
