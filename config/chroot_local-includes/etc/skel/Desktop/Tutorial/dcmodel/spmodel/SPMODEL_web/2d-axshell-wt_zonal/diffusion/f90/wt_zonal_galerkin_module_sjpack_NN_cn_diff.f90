...
!
!履歴  2009/10/04  竹広真一 wt_zonal_galerkin_NN_cn_diff.f90 より sjpack 用に改造
!
program wt_zonal_galerkin_module_sjpack_NN_cn_diff
  !
 ...
 !---- 変数 ----
  ...
  real(8), dimension(nm+1,2:lm)          :: wv_Temp    ! 温度
 ...
 !------------------- 初期値設定 ----------------------
  write(6,*) 'Total horizontal, longitudinal, radial wavenumbers: n,l?'
  read(5,*)n,l
 ...
 !------------------- 出力ルーチン ----------------------
  subroutine output_gtool4_init
    ...
    call HistoryCreate( &                                  ! ヒストリー作成
           file='wt_zonal_galerkin_module_sjpack_NN_cn_diff.nc', &
...
end program wt_zonal_galerkin_module_sjpack_NN_cn_diff
