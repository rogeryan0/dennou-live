...
!
!履歴  2009/09/24  竹広真一   w_spectrum_module_sjpack_test.f90 を改造
!
program w_spectrum_module_test
  ...
  call MessageNotify('M','w_spectrum_module_test', &
                         'w_spectrum_module tests succeeded!') 

end program w_spectrum_module_test
