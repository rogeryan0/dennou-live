...
program gami_adamsbashforth
 ...
 !---- 時間積分パラメター ----
  ...
  integer, parameter :: nt=10000, ndisp=2000      ! 時間積分数, 表示ステップ
...
contains
 ...
 !------------------- 時間変化項 ----------------------
  ...
  end subroutine TimeDerivetives

 !------------------- 出力 ----------------------
  subroutine output_gtool4_init
    call HistoryCreate( &                                  ! ヒストリー作成
           file='gami_adamsbashforth.nc', &
...
end program gami_adamsbashforth
