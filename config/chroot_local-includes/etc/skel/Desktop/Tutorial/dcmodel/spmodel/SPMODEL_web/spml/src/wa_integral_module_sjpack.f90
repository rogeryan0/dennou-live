...
!----------------------------------------------------------------------
!表題  wa_integral_module_sjpack
!
!  spml/wa_integral_module_sjpack モジュールは球面上での流体運動を
!  球面調和函数を用いたスペクトル法によって数値計算するための 
!  モジュール wa_module_sjpack の下部モジュールであり, 
!  積分・平均計算のための Fortran90 関数を提供する. 
!
!  球面上の 1 層モデル用 w_integral_module_sjpack モジュールを多層モデル用に
...
!
!++
module wa_integral_module_sjpack
  !
  != wa_integral_module_sjpack
  !
  ! Authors:: Shin-ichi Takehiro, Youhei SASAKI
  ! Version:: $Id: wa_integral_module_sjpack.f90,v 1.1 2009-09-07 07:26:49 takepiro Exp $
...
end module wa_integral_module_sjpack
