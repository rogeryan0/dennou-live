...
!----------------------------------------------------------------------
!
!表題  w_zonal_module_sjpack テストプログラム :: スペクトル解析関数のテスト
!
!履歴  2009/09/22  竹広真一
!
program w_zonal_module_sjpack_spectrum_test
  ...
  call MessageNotify('M','w_zonal_module_sjpack_spectrum_test',&
                         'w_zonal_module_sjpack spectrum function tests') 
  ...
  call MessageNotify('M','w_zonal_module_sjpack_spectrum_test',&
                         'w_zonal_module_sjpack spectrum function tests succeeded!')

end program w_zonal_module_sjpack_spectrum_test
