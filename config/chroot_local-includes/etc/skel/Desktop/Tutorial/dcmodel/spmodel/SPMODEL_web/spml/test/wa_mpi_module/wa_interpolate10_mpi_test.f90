...
!履歴  2008/05/29  竹広真一
!
program wa_interpolate10_mpi_test
 ...
 !---------------- MPI スタート ---------------------
  ...
  call MessageNotify('M','wa_Interpolate10_mpi_test', &
                         'wa_interpolate_module interpolate(10) tests') 
  ...
  call MessageNotify('M','wa_Interpolate10_mpi_test', &
                      'wa_interpolate_module interpolate(10) tests succeeded') 

 !------ MPIの終了 ------

  call MPI_FINALIZE(IERR)

end program wa_interpolate10_mpi_test
