...
!      トロイダルポテンシャルの境界値問題
!
!履歴  2009/09/06  竹広真一   wt_test_torvelbc.f90 より SJPACK 用に改造
!
program wt_module_sjpack_torvelbc_test
  ...
  call MessageNotify('M','wt_module_sjpack_torvelbc_test', &
       'wt_module_sjpack wt_TorgBoundariesGrid subroutine test')
  ...
  call MessageNotify('M','wt_test_torvelbc', &
       'wt_module  wt_TorvelBoundariesGrid subroutine test succeeded!')

end program wt_module_sjpack_torvelbc_test
