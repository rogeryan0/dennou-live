...
!
program wq_diff_cn_polvel_tau_F
  !
  !  wq_module サンプルプログラム
  !      球内のポロイダル速度場拡散問題(Crank-Nicolson scheme)
  !      外側すべり粘着条件
 ...
 !------------------- 時間積分 ----------------------
  do it=1,nt                               ! Crank-Nicolson 法による時間積分
     ...
     wq_Polvel = wq_LaplaPol2Pol_wq(wq_LaplaPolvel,cond='F')
...
99  continue
    ...
    subroutine CNDiffusionMatrixPolvel( Diffc, dt, DiffLUMatrix, kpivot )
      ...
      do l=0,lm
         ...
         wq_DI = wq_LaplaPol2Pol_wq(wq_DI,cond='F')
 ...
 !------------------- 出力ルーチン ----------------------
  subroutine output_gtool4_init
    ...
    call HistoryCreate( &                                  ! ヒストリー作成
           file='wq_diff_cn_polvel_tau_F.nc', &
...
end program wq_diff_cn_polvel_tau_F
