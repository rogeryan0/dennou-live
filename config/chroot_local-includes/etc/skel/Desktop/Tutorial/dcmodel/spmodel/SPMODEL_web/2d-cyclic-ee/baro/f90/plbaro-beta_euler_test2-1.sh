#!/usr/bin/env bash
#
# plbaro_euler_test1.1.f90 用実行シェルスクリプト
#
...
#
# real(8) :: U0              ! 平行流振幅
# real(8) :: Sigma           ! 平行流境界層幅

  &initflow  U0=1.0D0, Sigma=4.0D-2 /

# real(8) :: VorAmplitude    ! 渦の振幅(流線関数の値)
# real(8) :: VorRadius       ! 渦半径
# real(8) :: VorX0           ! 渦の初期位置 X 座標
# real(8) :: VorY0           ! 渦の初期位置 X 座標
