...
program wt_test_polvelbc
  ...
  call MessageNotify('M','wt_test_polvelbc', &
       'wt_module  wt_LaplaPol2polGrid_wt function tests')
        ...
        do j=1,jm
           do i=0,im-1
              if ( abs(xyz_True(i,j,k)) > eps ) then
                 ...
                 call MessageNotify('E','wt_test_polvelbc',&
