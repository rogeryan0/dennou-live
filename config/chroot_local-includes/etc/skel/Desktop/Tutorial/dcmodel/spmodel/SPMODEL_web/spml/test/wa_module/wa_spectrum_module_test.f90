...
!----------------------------------------------------------------------
!
!表題  wa_spectrum_module テストプログラム :: スペクトル関数のテスト
!
!履歴  2009/09/24  竹広真一 wa_spectrum_module_sjpack.f90 より改造
!
program wa_spectrum_module_test
  ...
  call MessageNotify('M','wa_spectrum_module_test',&
                         'wa_spectrum_module functions tests.') 
...
end program wa_spectrum_module_test
