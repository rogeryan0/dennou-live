...
!履歴  2008/05/26  竹広真一
!
program w_nterpolate01_mpi_test
 ...
 !---------------- MPI スタート ---------------------
  ...
  call MessageNotify('M','w_Interpolate01_mpi_test', &
                         'w_interpolate_module interpolate(01) tests') 
  ...
  call MessageNotify('M','w_test_Interpolate', &
                      'w_interpolate_module interpolate(01) tests succeeded!') 

 !------ MPIの終了 ------

  call MPI_FINALIZE(IERR)      

end program w_nterpolate01_mpi_test
