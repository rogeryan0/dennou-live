...
program eee_intavr
 ...
 !---- 変数 ----
  ...
  real(8)            :: zx_Data2(0:km2-1,0:im2-1)         ! 格子データ
  real(8)            :: zy_Data2(0:km2-1,0:jm2-1)         ! 格子データ
  real(8)            :: x_Data2(0:im2-1)                  ! 格子データ
  real(8)            :: y_Data2(0:jm2-1)                  ! 格子データ
  real(8)            :: z_Data2(0:km2-1)                  ! 格子データ
...
!-------------------------- 3 次元データ ------------------------------
  ...
  zyx_Data2 = sin(zyx_X) * cos(zyx_Y) * cos(zyx_Z)
  write(6,*) 'f = sin(X)*cos(Y)*cos(Z)'

    call check0d(IntZYX_zyx(zyx_Data2)-0.0, eps, 'IntZYX_zyx') 
    call check0d(AvrZYX_zyx(zyx_Data2)-0.0, eps, 'AvrXYX_zyx')

    call check1d(x_IntZY_zyx(zyx_Data2) - 0.0, eps, 'x_IntZY_zyx') 
    call check1d(x_AvrZY_zyx(zyx_Data2) - 0.0, eps, 'x_AvrZY_zyx') 
    call check1d(y_IntZX_zyx(zyx_Data2) - 0.0, eps, 'y_IntZX_zyx') 
    call check1d(y_AvrZX_zyx(zyx_Data2) - 0.0, eps, 'y_AvrZX_zyx') 
    call check1d(z_IntYX_zyx(zyx_Data2) - 0.0, eps, 'x_IntZY_zyx') 
    call check1d(z_AvrYX_zyx(zyx_Data2) - 0.0, eps, 'x_AvrZY_zyx') 

    call check2d(yx_IntZ_zyx(zyx_Data2) - 0.0, eps, 'yx_IntZ_zyx')
    call check2d(yx_AvrZ_zyx(zyx_Data2) - 0.0, eps, 'yx_AvrZ_zyx')
    call check2d(zx_IntY_zyx(zyx_Data2) - 0.0, eps, 'zx_IntY_zyx')
    call check2d(zx_AvrY_zyx(zyx_Data2) - 0.0, eps, 'zx_AvrY_zyx')
    call check2d(zy_IntX_zyx(zyx_Data2) - 0.0, eps, 'zy_IntX_zyx')
    call check2d(zy_AvrX_zyx(zyx_Data2) - 0.0, eps, 'zy_AvrX_zyx')

  zyx_Data2 = (1 - sin(zyx_X)) * cos(zyx_Y)**2 * cos(zyx_Z)**2
  write(6,*)
  write(6,*) 'f = (1-sin(X)) * cos(Y)**2 * cos(Z)**2'

    call check0d(IntZYX_zyx(zyx_Data2)-2.0*pi**3, eps, 'IntZYX_zyx') 
    call check0d(AvrZYX_zyx(zyx_Data2)-0.25, eps, 'AvrXYX_zyx')

    call check1d(x_IntZY_zyx(zyx_Data2) - (1 - sin(x_X))*pi**2, eps, 'x_IntZY_zyx') 
    call check1d(x_AvrZY_zyx(zyx_Data2) - (1 - sin(x_X))/4, eps, 'x_AvrZY_zyx') 
    call check1d(y_IntZX_zyx(zyx_Data2) - cos(y_Y)**2 * 2*pi**2, eps, 'y_IntZX_zyx') 
    call check1d(y_AvrZX_zyx(zyx_Data2) - cos(y_Y)**2 /2 , eps, 'y_AvrZX_zyx') 
    call check1d(z_IntYX_zyx(zyx_Data2) - cos(z_Z)**2 *2*pi**2 , eps, 'x_IntZY_zyx') 
    call check1d(z_AvrYX_zyx(zyx_Data2) - cos(z_Z)**2 /2, eps, 'x_AvrZY_zyx') 

    call check2d(yx_IntZ_zyx(zyx_Data2) &
         - (1 - sin(zyx_X(1,:,:)))*cos(zyx_Y(1,:,:))**2*pi, eps, 'yx_IntZ_zyx')
    call check2d(yx_AvrZ_zyx(zyx_Data2) &
         - (1 - sin(zyx_X(1,:,:)))*cos(zyx_Y(1,:,:))**2/2,eps, 'yx_AvrZ_zyx')
    call check2d(zx_IntY_zyx(zyx_Data2) &
         - (1 - sin(zyx_X(:,1,:)))*cos(zyx_Z(:,1,:))**2*pi, eps, 'zx_IntY_zyx')
    call check2d(zx_AvrY_zyx(zyx_Data2) &
         - (1 - sin(zyx_X(:,1,:)))*cos(zyx_Z(:,1,:))**2/2, eps,'zx_AvrY_zyx')
    call check2d(zy_IntX_zyx(zyx_Data2) &
         - cos(zyx_Y(:,:,1))**2 * cos(zyx_Z(:,:,1))**2*2*pi, eps, 'zy_IntX_zyx')
    call check2d(zy_AvrX_zyx(zyx_Data2) &
         - cos(zyx_Y(:,:,1))**2 * cos(zyx_Z(:,:,1))**2, eps, 'zy_AvrX_zyx')
...
!-------------------------- 2 次元データ ------------------------------
  ...
  yx_Data2 = sin(zyx_X(1,:,:)) * cos(zyx_Y(1,:,:))
  write(6,*) 'f = sin(X)*cos(Y)'
  ...
  yx_Data2 = (1 - sin(zyx_X(1,:,:))) * cos(zyx_Y(1,:,:))**2
  write(6,*)
  write(6,*) 'f = (1-sin(X)) * cos(Y)**2'

    call check0d(IntYX_yx(yx_Data2) - 2.0*pi**2, eps, 'IntYX_yx') 
    call check0d(AvrYX_yx(yx_Data2) - 0.5, eps, 'AvrYX_yx')

    call check1d(y_IntX_yx(yx_Data2) - 2*cos(y_Y)**2*pi, eps, 'y_IntX_yx') 
    call check1d(y_AvrX_yx(yx_Data2) - cos(y_Y)**2, eps, 'y_AvrX_yx')

    call check1d(x_IntY_yx(yx_Data2) - (1 - sin(x_X))*pi, eps, 'x_IntY_yx')
    call check1d(x_AvrY_yx(yx_Data2) - 0.5*(1 - sin(x_X)), eps, 'x_AvrY_yx')

  zx_Data2 = sin(zyx_X(:,1,:)) * cos(zyx_Z(:,1,:))
  write(6,*) 'f = sin(X)*cos(Y)'

    call check0d(IntZX_zx(zx_Data2)-0.0, eps, 'IntZX_zx') 
    call check0d(AvrZX_zx(zx_Data2)-0.0, eps, 'AvrZX_zx')

    call check1d(z_IntX_zx(zx_Data2) - 0.0, eps, 'z_IntX_zx') 
    call check1d(z_AvrX_zx(zx_Data2) - 0.0, eps, 'z_AvrX_zx') 

    call check1d(x_IntZ_zx(zx_Data2) - 0.0, eps, 'x_IntZ_zx')
    call check1d(x_AvrZ_zx(zx_Data2) - 0.0, eps, 'x_AvrZ_zx')

  zx_Data2 = (1 - sin(zyx_X(:,1,:))) * cos(zyx_Z(:,1,:))**2
  write(6,*)
  write(6,*) 'f = (1-sin(X)) * cos(Z)**2'

    call check0d(IntZX_zx(zx_Data2) - 2.0*pi**2, eps, 'IntZX_zx') 
    call check0d(AvrZX_zx(zx_Data2) - 0.5, eps, 'AvrZX_zx')

    call check1d(z_IntX_zx(zx_Data2) - 2*cos(z_Z)**2*pi, eps, 'z_IntX_zx') 
    call check1d(z_AvrX_zx(zx_Data2) - cos(z_Z)**2, eps, 'z_AvrX_zx')

    call check1d(x_IntZ_zx(zx_Data2) - (1 - sin(x_X))*pi, eps, 'x_IntZ_zx')
    call check1d(x_AvrZ_zx(zx_Data2) - 0.5*(1 - sin(x_X)), eps, 'x_AvrZ_zx')

  zy_Data2 = sin(zyx_Y(:,:,1)) * cos(zyx_Z(:,:,1))
  write(6,*) 'f = sin(Y)*cos(Y)'

    call check0d(IntZY_zy(zy_Data2)-0.0, eps, 'IntZY_zy') 
    call check0d(AvrZY_zy(zy_Data2)-0.0, eps, 'AvrZY_zy')

    call check1d(z_IntY_zy(zy_Data2) - 0.0, eps, 'z_IntY_zy') 
    call check1d(z_AvrY_zy(zy_Data2) - 0.0, eps, 'z_AvrY_zy') 

    call check1d(y_IntZ_zy(zy_Data2) - 0.0, eps, 'y_IntZ_zy')
    call check1d(y_AvrZ_zy(zy_Data2) - 0.0, eps, 'y_AvrZ_zy')

  zy_Data2 = (1 - sin(zyx_Y(:,:,1))) * cos(zyx_Z(:,:,1))**2
  write(6,*)
  write(6,*) 'f = (1-sin(Y)) * cos(Z)**2'

    call check0d(IntZY_zy(zy_Data2) - 2.0*pi**2, eps, 'IntZY_zy') 
    call check0d(AvrZY_zy(zy_Data2) - 0.5, eps, 'AvrZY_zy')

    call check1d(z_IntY_zy(zy_Data2) - 2*cos(z_Z)**2*pi, eps, 'z_IntY_zy') 
    call check1d(z_AvrY_zy(zy_Data2) - cos(z_Z)**2, eps, 'z_AvrY_zy')

    call check1d(y_IntZ_zy(zy_Data2) - (1 - sin(y_Y))*pi, eps, 'y_IntZ_zy')
    call check1d(y_AvrZ_zy(zy_Data2) - 0.5*(1 - sin(y_Y)), eps, 'y_AvrZ_zy')
...
!-------------------------- 1 次元データ ------------------------------
  ...
  write(6,*) 'f = 1-sin(2*X)'
    ...
    call check0d(IntX_x(x_Data2) - 2.0d0*pi, eps, 'IntX_x')
  ...
  write(6,*) 'f = cos(Y)**2'
    ...
    call check0d(IntY_y(y_Data2) - 1.0*pi, eps, 'IntY_y')
  ...
  write(6,*) 'f = 1-sin(2*Z)'
    ...
    call check0d(IntZ_z(z_Data2) - 2.0d0*pi, eps, 'IntZ_z')
    call check0d(AvrZ_z(z_Data2) - 1.0d0, eps, 'AvrZ_z')
