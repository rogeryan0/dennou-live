...
!
program wq_module_sjpack_deriv1_test
  ...
  call MessageNotify('M','wq_module_sjpack_deriv1_test', &
  ...
  call MessageNotify('M','wq_module_sjpack_deriv1_test', &
       'wq_module_sjpack derivative function test #1 succeeded!')

end program wq_module_sjpack_deriv1_test
