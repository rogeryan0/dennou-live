...
!
!履歴  2008/01/13  竹広真一  wu_test_derivative7.f90 より改変
...
program wtu_test_derivative17
  ...
  real(8), dimension(0:im-1,1:jm,0:kmi)   :: xyr_RotVLon  ! 慣性項(経度)
  real(8), dimension(0:im-1,1:jm,0:kmi)   :: xyr_RotVLat  ! 慣性項(緯度)
  real(8), dimension(0:im-1,1:jm,0:kmi)   :: xyr_RotVrad  ! 慣性項(動径)
  real(8), dimension(0:im-1,1:jm,0:kmi)   :: xyr_RotV0Lon  ! 慣性項(正解, 経度)
  real(8), dimension(0:im-1,1:jm,0:kmi)   :: xyr_RotV0Lat  ! 慣性項(正解, 緯度)
  real(8), dimension(0:im-1,1:jm,0:kmi)   :: xyr_RotV0rad  ! 慣性項(正解,動径)
