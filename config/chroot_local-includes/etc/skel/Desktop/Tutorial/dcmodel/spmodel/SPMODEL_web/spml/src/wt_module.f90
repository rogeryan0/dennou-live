...
!    関数を提供する. 
!
!    内部で wa_module, at_module を用いている. 最下部では球面調和変換
...
!      2008/06/28  佐々木洋平 水平方向の格子点を 0:im-1,1:jm に修正
!      2008/07/01  佐々木洋平 コメントを RDoc 用に微修正
!      2008/12/26  竹広真一  AvrRad_z バグ修正
!      2009/01/04  竹広真一  spml 書法に反するため Interpolate_array111_wt 削除
!      2009/01/08  竹広真一  wt_Initial メッセージ出力追加
...
module wt_module
  ...
  ! Version:: $Id: wt_module.f90,v 1.44 2010-03-02 10:09:07 uwabami Exp $
  ...
  !--------------- 初期化 -----------------
   subroutine wt_Initial(i,j,k,n,l,r_in,r_out,np,wa_init)
     ...
     call MessageNotify('M','wt_initial', &
          'wt_module (2009/07/31) is initialized')
