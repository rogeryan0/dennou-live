...
1000  xm = (xs + xl)/2.0
      ...
      if ( ValS * ValM .GT. 0.0D0 ) then
         xs = xm ; ValS=bessj(l,ra*xs)
      else
         xl = xm ; ValL=bessj(l,ra*xl)
      endif
