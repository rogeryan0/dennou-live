...
!
! Solving 2-D Boussinesq fluid system (FFFF problem)
...
program bsncnv1
 ...
 !------------------- 初期値設定 ----------------------
  yx_Temp = 1 -yx_Y
  yx_Temp(jm/2,im/2) = yx_Temp(jm/2,im/2) + 0.01        ! 温度擾乱追加
  yx_Psi  = 0.0
  yx_Zeta = 0.0
...
contains
    ...
    subroutine output_gtool4_init
      call HistoryCreate( &                               ! ヒストリー作成
           file='bsncnv_2_et_ff.nc', title='Boussinesq convection (FFFF)', &
