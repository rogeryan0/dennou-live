...
!
!履歴  2009/09/18  竹広真一  wt_galerkin_ND_cn_diff.f90 を sjpack 用に改造
!
program wt_galerkin_module_sjpack_ND_cn_diff
  !
 ...
 !---- 変数 ----
  ...
  real(8), dimension((nm+1)**2,2:lm) :: wb_Temp    ! 温度
...
99  continue
   ...
   !------------------- 拡散項 ----------------------
    subroutine CNDiffusionMatrixND( Diffc, dt, DiffLUMatrix, kpivot )
      ...
      real(8)               :: wb_I((nm+1)*(nm+1),2:lm)       ! 作業用変数
 ...
 !------------------- 出力ルーチン ----------------------
  subroutine output_gtool4_init
    ...
    call HistoryCreate( &                                  ! ヒストリー作成
           file='wt_galerkin_module_sjpack_ND_cn_diff.nc', &
...
end program wt_galerkin_module_sjpack_ND_cn_diff
