...
program wu_test_derivative6
  ...
  real(8), dimension(0:im-1,1:jm,0:km)     :: xyr_VLon  ! 速度(経度)
  real(8), dimension(0:im-1,1:jm,0:km)     :: xyr_VLat  ! 速度(緯度)
  real(8), dimension(0:im-1,1:jm,0:km)     :: xyr_Vrad  ! 速度(動径)
  real(8), dimension(0:im-1,1:jm,0:km)     :: xyr_V0Lon  ! 速度(正解, 経度)
  real(8), dimension(0:im-1,1:jm,0:km)     :: xyr_V0Lat  ! 速度(正解, 緯度)
  real(8), dimension(0:im-1,1:jm,0:km)     :: xyr_V0rad  ! 速度(正解,動径)
