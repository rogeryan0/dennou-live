...
!      磁場トロイダルポテンシャルの境界値問題
!
!履歴  2009/09/06  竹広真一   wt_test_tormagbc.f90 より SJPACK 用に改造
!
program wt_module_sjpack_tormagbc_test
 ...
 !==================== wt_TormagBoundariesGrid =========================
  ...
  call MessageNotify('M','wt_module_sjpack_tormagbc_test', &
       'wt_module_sjpack wt_TormagBoundaries subroutine test succeeded!')

end program wt_module_sjpack_tormagbc_test
