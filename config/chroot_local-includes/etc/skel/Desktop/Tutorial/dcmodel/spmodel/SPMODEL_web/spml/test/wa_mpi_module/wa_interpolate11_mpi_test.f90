...
!履歴  2008/05/29  竹広真一
!
program wa_interpolate11_mpi_test
  ...
  real(8) :: Alon(3)
  real(8) :: Alat(3)
  real(8), dimension(3,km) :: a_data_sol
  real(8) :: error
  real(8) :: pi
 ...
 !---------------- MPI スタート ---------------------
  ...
  call MessageNotify('M','wa_test_Interpolate', &
                         'wa_interpolate_module interpolate(11) tests') 
  ...
  call MessageNotify('M','wa_test_Interpolate', &
                      'wa_interpolate_module interpolate(11) tests succeeded') 

 !------ MPIの終了 ------

  call MPI_FINALIZE(IERR)

end program wa_interpolate11_mpi_test
