...
!
!履歴  2009/09/18  竹広真一  wt_galerkin_RR_cn_diff.f90 を sjpack 用に改造
!
program wt_galerkin_module_sjpack_RR_cn_diff
  !
 ...
 !------------------- 出力ルーチン ----------------------
  subroutine output_gtool4_init
    ...
    call HistoryCreate( &                                  ! ヒストリー作成
           file='wt_galerkin_module_sjpack_RR_cn_diff.nc', &
...
end program wt_galerkin_module_sjpack_RR_cn_diff
