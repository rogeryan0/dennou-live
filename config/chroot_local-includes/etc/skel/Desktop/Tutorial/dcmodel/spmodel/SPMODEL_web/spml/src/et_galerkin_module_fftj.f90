...
!----------------------------------------------------------------------
!
!表題  et_galerkin_module_fftj
!
!      2 次元水路領域
!      Fourier 展開 + チェビシェフ−ガラーキン法用モジュール(fftj 版)
!
!履歴  2009/09/16  竹広真一  et_galerkin_module.f90 を fftj 用に改造
!      2010/03/10  佐々木洋平  threadprivate 削除(コンパイラ依存)
!
!++
module et_galerkin_module_fftj
  !
  != et_galerkin_module_fftj
  !
  ! Authors:: Shin-ichi Takehiro, Youhei SASAKI
  ! Version:: $Id: et_galerkin_module_fftj.f90,v 1.2 2010-03-02 10:09:03 uwabami Exp $
  ...
  ! Fourier 展開 + チェビシェフ−ガラーキン法用モジュール(fftj 版)
  !
  ! spml/et_galerkin_module_fftj モジュールは 2 次元チャネル領域での流体運動
  ...
  !
  ! 内部で et_module_fftj, および境界条件を解くためにチェビシェフーガラーキン法の
...
end module et_galerkin_module_fftj
