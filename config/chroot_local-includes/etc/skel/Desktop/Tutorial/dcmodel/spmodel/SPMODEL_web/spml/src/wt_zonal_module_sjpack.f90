...
!----------------------------------------------------------------------
!表題  wt_zonal_module_sjpack
!
!    spml/wt_zonal_module_sjpack モジュールは球面上および球殻内での経度方向に
...
!    関数を提供する. 
!
!    内部で wa_zonal_module_sjpack, at_module を用いている. 最下部では
!    ルジャンドル多項式およびチェビシェフ多項式変換のエンジンとして 
!    ISPACK の Fortran77 サブルーチンを用いている.
!
!    関数, サブルーチンの名前と機能は wt_zonal_module のものと同じに
!    設計してある. したがって use 文を wt_zonal_module から 
!    wt_zonal_module_sjpack に変更するだけで SJPACK の機能が使えるようになる. 
!
!履歴  2009/09/25  竹広真一  wt_zonal_module より SJPACK 用に改造
...
!
!++
module wt_zonal_module_sjpack
  !
  != wt_zonal_module_sjpack
  !
  ! Authors:: Shin-ichi Takehiro, Youhei SASAKI
  ! Version:: $Id: wt_zonal_module_sjpack.f90,v 1.2 2010-03-02 10:09:07 uwabami Exp $
...
end module wt_zonal_module_sjpack
